...
public static class AuthorizationPolicies
{
    ...
    public const string CanViewMaintenance=nameof(CanViewMaintenance);public const string CanCreateMaintenanceRequest=nameof(CanCreateMaintenanceRequest);public const string CanManageMaintenanceRequests=nameof(CanManageMaintenanceRequests);public const string CanManageMaintenanceWorkOrders=nameof(CanManageMaintenanceWorkOrders);public const string CanManagePreventiveMaintenance=nameof(CanManagePreventiveMaintenance);public const string CanManageMaintenanceChecklists=nameof(CanManageMaintenanceChecklists);public const string CanUseMaintenanceParts=nameof(CanUseMaintenanceParts);public const string CanVerifyMaintenance=nameof(CanVerifyMaintenance);public const string CanViewMaintenanceCosts=nameof(CanViewMaintenanceCosts);
}
